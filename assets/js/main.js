...
(function ($) {
    ...
    $(function () {
        $("#mint_menu_btn").click(function () {
            ...
            $(".dogeblack_header").removeClass("active");
        });
    });
    $(function () {
        $("#mint_menu_btn").click(function () {
            $(".dogeblack_mint_header").removeClass("dogeblack_header");
        });
    });
    ...
    $(function () {
        $(".menu_bar").click(function () {
            $(".dogeblack_mobile_menu").show();
        });
        $(".mobile-menu-hide, .mobile_menu_close_btn, .mobile_menu_social_links").click(function () {
            $(".dogeblack_mobile_menu").hide();
            $(".mobile-sub-menu-list").hide();
        });
    });
    window.onclick = function (event) {
        if (event.target == dogeblack_mobile_menu) {
            dogeblack_mobile_menu.style.display = "none";
        }
    }
